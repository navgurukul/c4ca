...
//         <Card key={index} sx={{ border: 1, borderColor: item.borderColor,backgroundColor:item.backgroundColor, borderRadius: "8px", mb: "32px" ,width:'96%' }}>
//           <CardContent>
...
//                 </Typography>
//                 {/* <Typography variant="body1" sx={{ whiteSpace: 'pre-wrap' }}>
//                   <img src={item.timer}  />{item.deadline}
//                 </Typography> */}
//               </Grid>
//               <Grid item>
//                 <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
//                   <CircularProgress variant="determinate" value={item.progress} size={30} thickness={6} />
//                   <Typography variant="body1" sx={{ marginLeft: '10px' }}>{item.progress} {item.progress !== "" && '%'}</Typography>
//                 </Box>
//               </Grid>
//             </Grid>
...
//               {
//                 item.buttonText !== "Learn on Meraki" ? (
  ...
  <Card
    ...
    <CardContent>
        ...
        <Grid item>
          <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
            ...
            <Typography variant='body1' sx={{ marginLeft: '5px' }}>
              {openedCards >= index ? `${item.progress }%` : 'Not Started'}
            </Typography>
          </Box>
        </Grid>
      </Grid>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'flex-end', pr: 2, pb: 2, mt: '16px' }}>
        ...
        endIcon={openedCards >= index && <LaunchIcon /> }
